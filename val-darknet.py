...
from darknet import Darknet ,load_darknet_weights 
...
def run(data,
    ...
    if training:  # called by train.py
        ...
        # model.convert2rt( opt.weights.replace(".pt", ".wts") )) 
...
def parse_opt():
    ...
    parser.add_argument('--cfg', type=str, default='', help='dataset.yaml path')
