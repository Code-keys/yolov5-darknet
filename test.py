...
def test(data,
    ...
    if not training:
        ...
        dataloader = create_dataloader(path, imgsz, batch_size, 2*model.stride.max(), opt, pad=0.5, rect=True)[0]
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        for si, pred in enumerate(output):
            ...
            if save_json:
                ...
                # box[:, 2:4] += 1  # xy center to top-left corner
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/home/gy/CX/yolov5-4.0/weights/yolov5s/exp2/weights/last.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--json', default="/home/gy/CX/VisDrone/val/gt.json", help='save a cocoapi-compatible JSON results file')
    parser.add_argument('--name', default='test', help='save to project/name')
    parser.add_argument('--Multi_scale', default=False, help='Multi_scale')
