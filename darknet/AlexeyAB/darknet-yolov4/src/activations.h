...
//typedef enum{
//    LOGISTIC, SILU, RELU, RELIE, LINEAR, RAMP, TANH, PLSE, LEAKY, ELU, LOGGY, STAIR, HARDTAN, LHTAN, SELU, SWISH, MISH
//}ACTIVATION;
...
static inline float silu_activate(float x){return (1-x)*x*x + 1.f /(1.f + expf(-x));}
